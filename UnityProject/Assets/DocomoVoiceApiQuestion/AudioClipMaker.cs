...
{
    // ref https://github.com/Suzeep/audioclip_maker/blob/master/Assets/Scripts/AudioClipMaker.cs
    ...
    public class AudioClipMaker : MonoBehaviour
    {
        ...
        )
        {
            ...
            // create clip and set
            return Create(name, ranged_raw_data, samples, channels, frequency, isStream);
        }
